...
def train(sc, data_path,
    ...
    if action == "train":
        ...
        results = model.evaluate(val_rdd, options.batchSize, [Top1Accuracy()])
...
if __name__ == "__main__":
    ...
    parser.add_option("-m", "--maxEpoch", type=int, dest="maxEpoch", default=20)
