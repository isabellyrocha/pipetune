...
def start_application(total_executor_cores, executor_cores, memory, dataset, batch_size, mnist_id):
    file_name = "lenet_%s_%s_%s_%s_%d" % (dataset, total_executor_cores, memory, batch_size, mnist_id)
